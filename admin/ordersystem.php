...
<div class="container" id="updatedata">
    ...
    $sql = "SELECT * FROM `order_prod` WHERE op_orderApproved = '' AND op_addons = ''";
    ...
    while ($row = array_shift($result)) {
        ...
        while ($rowUser = array_shift($resultUser)) {
            $UFname = $rowUser['ua_fullname'];
        }

        $op_id = $row['op_id'];
    ?>

        <a href="orderlist?id=<?php echo $row['op_id']; ?>" class="five">
            <div class="card text-center shadow p-1 mb-3 rounded">
                <div class="row">
                    <div class="col-sm">
