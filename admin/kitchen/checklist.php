...
<body>
    ...
    <div class="container" style="padding-top: 150px">
        ...
        <div class="row text-bg-light my-3" >
            <h1 class="text-bg-light my-1">List of Order</h1>
        </div>
            ...
            <div class="card shadow p-3 mb-5 rounded">
                    ...
                    ?>
                        ...
                        <div class="card text-center shadow p-3 mb-4 rounded">
                            <div class="row">
                                ...
                                ?>
                                    <div class="col-sm text-start" style="margin: auto;">
                                        <form action="update_kcodes" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="cartId" value="<?php echo $rowimg['cart_id'] ?>">
                                            <input type="hidden" name="orderID" value="<?php echo $orderID ?>">
                                            <div class="form-check">
                                                <button class="btn btn-primary btn-lg" type="submit" name="btnCheck">Check</button>
                                            </div>
                                        </form>
                                    </div>
                                <?php
                ...
                <form action="update_kcodes" method="POST" enctype="multipart/form-data">
                    <div class="row text-end my-3">
                        ...
                        <div class="col-sm">
                            <button class="btn btn-success btn-lg" type="submit" name="btnProcess">SERVED</button>
